<nav class="navbar navbar-default navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<form class="navbar-form navbar-left" method="GET" action="/restoran">
					<div class="input-group">
						<input name="cari" type="text" value="" class="form-control" placeholder="Search dashboard...">
						<span class="input-group-btn"><button type="submit" class="btn btn-primary">Go</button></span>
					</div>

					<button type="button" class="btn" class="btn-remove" data-toggle="modal" data-target="#exampleModal">Tambah Data</button>
